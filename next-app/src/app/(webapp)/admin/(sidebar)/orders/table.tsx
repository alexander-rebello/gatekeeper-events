...
export default function OrderTable({ data, canView }: { data: Order[]; canView: boolean }) {
	...
	let columns = [
		...
		columnHelper.accessor("tickets_delivered", {
			header: "Delivered",
					...
					columnHelper.display({
						...
						cell: (props) => (
							<OverlayTrigger overlay={<Tooltip>View/Edit</Tooltip>}>
								<Link className='link-primary bg-transparent border-0' href={`/admin/orders/${props.row.original.uuid}`}>
